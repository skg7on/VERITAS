...
| M11 | Design approved; replacement plan pending | [unified IR acquisition and shared ingest-boundary spec](m11-m12-summarydb-ingest-adapters-design-spec.md) | Existing narrow plan superseded; replacement pending written-spec review | [#20](https://github.com/skg7on/VERITAS/issues/20) |
