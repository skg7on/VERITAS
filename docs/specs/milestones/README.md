...
| M10C | Planned | [spec](m10c-evidence-ir-semantic-model-serialization-design-spec.md) | [plan](../../plans/milestones/m10c-evidence-ir-semantic-model-serialization-implementation-plan.md) | — |
