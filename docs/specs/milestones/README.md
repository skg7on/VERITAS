...
| M12A–M12C | Architecture approved; written spec under review | [Joern/SummaryDB spec](m12-joern-cpg-summarydb-importer-design-spec.md); [shared boundary](m11-m12-summarydb-ingest-adapters-design-spec.md) | Existing [legacy plan](../../plans/milestones/m12-external-facts-importer-implementation-plan.md) must be replaced after written-spec approval | [#21](https://github.com/skg7on/VERITAS/issues/21) |
